...
const ClosingSection = () => {
  ...
  const startHeartRain = () => {
    ...
    const createHeart = () => {
      ...
      heart.className = 'absolute text-2xl animate-falling-hearts pointer-events-none';
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-rose-100 to-pink-200 relative overflow-hidden">
      ...
      <div ref={heartRainRef} className="absolute inset-0 pointer-events-none z-10"></div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-rose-200 mb-12">
            <div className="font-script text-xl md:text-2xl text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                These past six months have been nothing short of magical. You've brought color 
                to my world in ways I never thought possible. Every morning I wake up grateful 
                for another day to love you, and every night I fall asleep counting the reasons 
                why you're perfect for me.
              </p>
              
              <p>
                You are my sunshine on cloudy days, my anchor in stormy weather, and my greatest 
                adventure all wrapped into one beautiful soul. I love the way you laugh at my 
                terrible jokes, how you make everything better just by being there, and the way 
                you see the world with such wonder and kindness.
              </p>
              
              <p>
                Six months down, forever to go. I can't wait to create a million more memories 
                with you, to explore new places, to grow together, and to love you more deeply 
          ...
          {!showSecret ? (
            ...
            >
              ...
              <p className="text-lg opacity-90">
                Here's to all the adventures yet to come, all the laughs we'll share, 
                all the dreams we'll chase together, and all the love that will only 
                grow stronger with time. You and me, always and forever. 💕
              </p>
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-32 right-1/4 animate-float" style={{ animationDelay: '0.5s' }}>
